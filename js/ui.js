function refreshViews(jenkins_root_url) {
  ...
  function getAlertLevel(view_stat_type, value) {
    ...
    var thresholds = {};
    thresholds[VIEW_STAT_TYPE.passed]      = { 'warning': 90, 'good': 100 };
    thresholds[VIEW_STAT_TYPE.coverage]    = { 'warning': 60, 'good': 70 };
    thresholds[VIEW_STAT_TYPE.last_failed] = { 'warning': 60 * 60 * 12, 'good': 60 * 60 * 24 };
    thresholds[VIEW_STAT_TYPE.duration]    = { 'warning': 90, 'good': 100 };
  ...
  function buildJobInfoBox(view_stat_type, value) {
    ...
    var stat_label, 
        stat_value, 
        stat_alert = getAlertLevel(view_stat_type, value);
